...
const SalonInbox = () => {
  ...
  const handleEliminarSalonClick = (id) => {
    ...
    // Llama al método de bloqueo del cliente
    ClienteSalon.eliminarSalon(id)
      .then(response => {
        // Aquí puedes manejar la respuesta si es necesario
        console.log('Salón bloqueado con éxito:', response.data);
      })
      .catch(error => {
        // Maneja el error
        console.error('Error al bloquear el salón:', error);
      });
  ...
  const handleBloquearClick = (id) => {
    ...
    // Llama al método de bloqueo del cliente
    ClienteSalon.cambiarEstadoSalon(id, false)
      .then(response => {
        // Aquí puedes manejar la respuesta si es necesario
        console.log('Salón bloqueado con éxito:', response.data);
      })
      .catch(error => {
        console.log("salon elegido", id);
        // Maneja el error
        console.error('Error al bloquear el salón:', error);
      });
